...
users_df.select("first_name").alias("shubh").show()
...
users_df.select(user_id.alias("shubh")).show()

# COMMAND ----------

users_df.orderBy("amount_paid").asc().show()

# COMMAND ----------

users_df.orderBy(col("amount_paid").asc()).show()
