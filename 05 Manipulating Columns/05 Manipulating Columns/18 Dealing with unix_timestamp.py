...
datetimesDF. \
    withColumn("unix_date_id", unix_timestamp(col("dateid").cast("string"), "yyyyMMdd")).show()
#     withColumn("unix_time",unix_timestamp(("time")).show()

# COMMAND ----------

datetimesDF.unix_timestam
...
unixtimesDF. \
    withColumn("date", from_unixtime("unixtime")). \
