...
employeesDF.groupBy('first_name').count().show()
...
employeesDF.orderBy('nationality').show()

# COMMAND ----------

employeesDF.orderBy('nationality',ascending=False).show()

# COMMAND ----------

employeesDF.orderBy(employeesDF.nationality.desc()).show()

# COMMAND ----------

employeesDF.orderBy(col('nationality').desc()).show()

# COMMAND ----------

employeesDF.orderBy(['salary','employee_id'],ascending=[0,1]).show()   #need to know 
