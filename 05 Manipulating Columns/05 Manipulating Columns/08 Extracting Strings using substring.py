...
df.withColumn(substring(lit("Hello World"), 7, 5). \
  show()

# COMMAND ----------

df.select(substring(lit('shbh'),1,2)).show()
...
emp=[[1,"shbha","chavan"],[2,"sh","ooo"]]

# COMMAND ----------

df=spark.createDataFrame(emp,schema="""id int,name string,surname string""")
